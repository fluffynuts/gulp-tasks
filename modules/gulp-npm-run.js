...
(function () {
    ...
    const { readFileSync } = require("fs"), debug = require("debug")("gulp-npm-run"), exec = require("./exec"), path = require("path"), chalk = require("ansi-colors"), findNpmBase = require("./find-npm-base");
