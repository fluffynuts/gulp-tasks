...
(function() {
    const
        ...
        { rm, ls, FsEntities, readTextFile, mkdir } = require("yafs"),
        seed = requireModule<Seed>("seed"),
        ...
        nunitRunner = require("./modules/gulp-nunit-runner"),
        ...
        { baseName, chopExtension } = requireModule<PathUtils>("path-utils");
