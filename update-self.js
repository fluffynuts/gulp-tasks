...
const spawn = requireModule("spawn"), gulp = requireModule("gulp"), env = requireModule("env"), chalk = requireModule("ansi-colors"), resolveMasks = requireModule("resolve-masks"), debug = require("debug")("update-self"), es = require("event-stream");
env.associate([
    env.DRY_RUN,
